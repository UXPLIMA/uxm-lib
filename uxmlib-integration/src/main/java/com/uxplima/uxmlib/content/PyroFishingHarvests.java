...
/**
 * CustomHarvests over PyroFishingPro.
 *
 * <p>PyroFishingPro is the other fishing plugin a server in this market runs, and it answers the same question under a different name.
 *
 * <p>Reflective, like every provider in this package.
 */
public final class PyroFishingHarvests implements CustomHarvests {

    /** The Bukkit plugin name, which is the whole of the present guard. */
    static final String PLUGIN = "PyroFishingPro";

    /** The namespace an id of this vendor's carries. */
    static final String NAMESPACE = "pyrofishing";
    ...
    private static final String CATCH_METHOD = "getFishId";

    private static final String API = "me.pyrotexnix.pyrofishingpro.PyroFishingPro";

    private final Server server;

    public PyroFishingHarvests(Server server) {
