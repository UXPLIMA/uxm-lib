 ...
 * {@link com.uxplima.uxmlib.hook.PluginHook} is the shared contract.
 * {@link com.uxplima.uxmlib.hook.Integrations} resolves a plugin's optional integrations once, each to a
 * typed capability with a no-op default, and is the one to reach for when the other plugin loads first. The economy and permission
